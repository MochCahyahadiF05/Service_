...
<body>
  ...
  <div class="authentication-wrapper authentication-2 ui-bg-cover ui-bg-overlay-container px-4" style="background-image: url('assets/img/bg/bg.jpg');">
      ...
      <div class="card">
        <div class="p-4 p-sm-5">
          ...
          {{-- <div class="d-flex justify-content-center align-items-center pb-2 mb-4">
            <div class="ui-w-60">
              <div class="w-100 position-relative" style="padding-bottom: 50%">
                <img src="assets/img/logoa.png" alt="" width="85px">
